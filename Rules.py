print ("""The goal of Reversi is to have the majority of the discs changed to your colored when the last game piece is placed. Reversi is a 2 player game that is played on a grid of 8 x 8. 
