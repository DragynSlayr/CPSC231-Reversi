...
def main():
	...
	game_state = ListInterpret.stringInterpret(game_state, "D4", 0, True)
	game_state = ListInterpret.stringInterpret(game_state, "E4", 1, True)
	game_state = ListInterpret.stringInterpret(game_state, "E5", 2, True)
	game_state = ListInterpret.stringInterpret(game_state, "D5", 3, True)
	move_num = 4
